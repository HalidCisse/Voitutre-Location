      ...
      If ChampsAddResOK Then
         x = MsgBox("Efféctuer l'enregistrement ?", vbYesNoCancel + vbQuestion, "Gestion Location de Voitures : Enregistrement")
          If x = vbYes Then
             ...
             x = MsgBox("Voulez Vous Imprimer La Facture", vbQuestion + vbYesNo, "Gestion Location de Voiture")
                If x = vbYes Then
                  OpenReportRES (FrmReserver.TextResID.Text)
                End If
             Unload Me
